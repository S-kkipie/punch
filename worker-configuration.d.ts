/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6aa0e2889e1bdec5b994323e0632012a)
// Runtime types generated with workerd@1.20260804.1 2025-04-01 nodejs_compat,nodejs_compat_populate_process_env
interface __BaseEnv_Env {
	HYPERDRIVE: Hyperdrive;
	DATABASE_URL: string;
	BETTER_AUTH_SECRET: string;
	NEXT_PUBLIC_APP_URL: string;
	WALLET_MASTER_MNEMONIC: string;
	NEXT_PUBLIC_DEMO_MODE: string;
	NEXT_PUBLIC_DEMO_PASSWORD: string;
	CHAIN_ENV: string;
	CHAIN_RPC_URL: string;
	DATABASE_SSL: string;
	PUNCH_WORKER: DurableObjectNamespace<import("./src/worker/cf").PunchWorker>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker/cf");
		durableNamespaces: "PunchWorker";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "BETTER_AUTH_SECRET" | "NEXT_PUBLIC_APP_URL" | "WALLET_MASTER_MNEMONIC" | "NEXT_PUBLIC_DEMO_MODE" | "NEXT_PUBLIC_DEMO_PASSWORD" | "CHAIN_ENV" | "CHAIN_RPC_URL" | "DATABASE_SSL">> {}
}
